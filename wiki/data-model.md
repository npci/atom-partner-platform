...
| Column | Holds |
|---|---|
| `authority_counter` | The *active* counter-proposal, `NULL` when none is open |
| `authority_counter_history` | Append-only log of every counter and how it resolved |
...
| `authority_followups`, `round_notices`, `emergency_issues` | Append-only message logs |
