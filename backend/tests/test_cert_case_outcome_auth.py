...
_BODY = {
    "authority_change_id": "f989926b-2dd3-40d9-955b-a07bfca89b89",
    "case_id": "LL_1",
    "status": "passed",
}
...
def test_correct_token_is_admitted_and_forwards(monkeypatch):
    ...
    monkeypatch.setattr(authority_client, "send_cert_case_result", _fake_send)
...
def test_evidence_is_persisted_even_when_the_forward_fails(monkeypatch):
    ...
    monkeypatch.setattr(authority_client, "send_cert_case_result", _boom)
