...
"""Tests for review_base.sanitize_findings, including the
root_cause/principle_ref enrichment."""
...
class TestRootCauseAndPrincipleRefEnrichment:
    ...
    def test_preserves_model_supplied_principle_ref(self):
        out = sanitize_findings({
            "summary": "x",
            "findings": [{"title": "t", "principle_ref": "Vault-First Rule"}],
        })
        assert out["findings"][0]["principle_ref"] == "Vault-First Rule"
