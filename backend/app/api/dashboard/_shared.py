...
# Used by the download endpoints. The authority generates a .docx for every Product Kit
...
# so every doc remains downloadable in the format the authority advertises.
