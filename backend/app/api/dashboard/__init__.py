...
router = APIRouter()
for _module in (changes, queries, decision, defects, drafts, progress, certification, cert_fix, settings, design, testing, code, knowledge, code_repo, jobs, profile, domain):
