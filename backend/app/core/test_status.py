...
These are test-execution outcomes reported by the authority's certification run — the
...
A "Use Of Hardcoded Password" static-analysis rule matches a short literal
...
bare literal the rule keys on. `PASS` also reads unambiguously as a test
