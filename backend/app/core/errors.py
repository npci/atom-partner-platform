...
"""Structured error taxonomy — a clear split between business and technical
errors.
...
class PartnerPlatformError(Exception):
    ...
    Categories:
      ...
      resource_access   — a dependency (DB, LLM provider, GitLab, the authority) failed
...
class AuthorityDeliveryError(PartnerPlatformError):
    category = "resource_access"
    code = "authority_delivery_failed"
