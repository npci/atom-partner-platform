...
back this with a shared store (Redis) instead of in-memory state.

Every dependency call MUST have a timeout, circuit breaker, and bulkhead.
"""
...
# limits stay centrally configured. ─────────────────────────────────────────
