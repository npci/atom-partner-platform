...
These are the platform's foundational architecture and security principles. The
list below is complete and self-contained — it governs every generation and
review decision you make. Treat them as binding constraints, not suggestions.
...
You MUST NOT introduce these anti-patterns:
