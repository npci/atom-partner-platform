...
Mirrors the authority's `backend/app/rag/embeddings.py` but talks to the partner's own
...
def _embed_batch(texts: list[str]) -> list[list[float]] | None:
    ...
    Wrapped in the `ollama_embed` circuit breaker. The boundary's limits have always
