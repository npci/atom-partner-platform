...
Standalone copy of the authority's ingest pipeline, adapted to the partner's Ollama
embeddings + the shared chunk store. Deliberately simpler than the authority's
