...
"""Git Integrator (partner side) — Code RAG.
...
Standalone + deliberately simpler than the authority's `backend/app/services/
git_integrator.py` (no multi-repo grouping, no build-phase state machine, no
