...
Retention + purgeability are mandatory dataset properties, and TTL, validity,
archival, and temporality rules apply to every dataset the platform owns.
...
copy of authority-issued content and are NOT purged by this module (per the data
classification rationale: they're a justified, non-owner working copy, not a
cache).
"""
