...
// ── WHY THIS EXISTS ─────────────────────────────────────────────────────────
//
// Static analysis reported CodePanel.jsx:352 under THREE queries — DOM XSS,
// reflected XSS and DOM open redirect — all following one
...
check('CodePanel does not reference mr_url',
  ...
  + 'the scanner reported three times. Use project_path + mr_iid instead.');
