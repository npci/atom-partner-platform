...
//
// A permissive-Content-Security-Policy weakness was reported against
...
// frame buster required to cover clickjacking on legacy
// browsers, which is a static check on the HTML document and cannot be
