...
// ── Why this exists ─────────────────────────────────────────────────────────
//
// Static analysis reported the MR link under three queries — DOM XSS,
// reflected XSS and DOM open redirect — all tracing the same
 ...
 *
 * @param {string} projectPath  GitLab namespace, e.g. 'group/service-stack'
