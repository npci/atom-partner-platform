 ...
 *
 * Removing the `href` deletes the sink. Static analysis reported this one line
 * under three separate queries — DOM XSS, reflected XSS, and DOM open
 * redirect — all tracing the same
